...
## Disable IR Remote (so Apple TV doesn't affect computer)
...
## Spactacle: move and resize windows with ease
...
# brew cask install chromecast chrome-remote-desktop-host
brew cask install google-chrome && defaults write com.google.Chrome AppleEnableSwipeNavigateWithScrolls -bool false
...
## BROWSER PLUGINS
# brew casek install lastpass-universal
# brew cask install silverlight flash-player
